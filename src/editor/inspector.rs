            ...
            if let Some(mut entity_mut) = world.get_entity_mut(entity) {
                ...
                if let Some(mut transform) = entity_mut.get_mut::<Transform>() {
                    ...
                    ui.horizontal(|ui| {
                        ...
                        ui.add(egui::DragValue::new(&mut transform.scale.z).prefix("Z: ").speed(0.01));
                    });
                    
                    // 旋转编辑 (简化版,直接编辑四元数)
                    ui.horizontal(|ui| {
                        ui.label("Rotation:");
                        ui.add(egui::DragValue::new(&mut transform.rot.x).prefix("X: ").speed(0.01));
                        ui.add(egui::DragValue::new(&mut transform.rot.y).prefix("Y: ").speed(0.01));
                        ui.add(egui::DragValue::new(&mut transform.rot.z).prefix("Z: ").speed(0.01));
                        ui.add(egui::DragValue::new(&mut transform.rot.w).prefix("W: ").speed(0.01));
                    });
