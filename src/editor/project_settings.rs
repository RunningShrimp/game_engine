    ...
    pub fn render(&mut self, ui: &mut egui::Ui) {
        ...
        ui.collapsing("Render Settings", |ui| {
            ui.horizontal(|ui| {
                ...
                if ui
                    .add(
                        egui::DragValue::new(&mut self.settings.render_settings.window_width)
                            .prefix("W: "),
                    )
                    .changed()
                {
                ...
                if ui
                    .add(
                        egui::DragValue::new(&mut self.settings.render_settings.window_height)
                            .prefix("H: "),
                    )
                    .changed()
                {
            ...
            if ui
                .checkbox(&mut self.settings.render_settings.fullscreen, "Fullscreen")
                .changed()
            {
                self.has_unsaved_changes = true;
            }
            ...
            ui.horizontal(|ui| {
                ...
                if ui
                    .add(
                        egui::DragValue::new(&mut self.settings.render_settings.max_fps)
                            .range(0..=300),
                    )
                    .changed()
                {
            ...
            ui.horizontal(|ui| {
                ...
                if ui
                    .add(
                        egui::DragValue::new(&mut self.settings.render_settings.msaa_samples)
                            .range(1..=8),
                    )
                    .changed()
                {
        ...
        ui.collapsing("Physics Settings", |ui| {
            ui.horizontal(|ui| {
                ...
                if ui
                    .add(
                        egui::DragValue::new(&mut self.settings.physics_settings.gravity[0])
                            .prefix("X: ")
                            .speed(0.1),
                    )
                    .changed()
                ...
                if ui
                    .add(
                        egui::DragValue::new(&mut self.settings.physics_settings.gravity[1])
                            .prefix("Y: ")
                            .speed(0.1),
                    )
                    .changed()
                ...
                if ui
                    .add(
                        egui::DragValue::new(&mut self.settings.physics_settings.gravity[2])
                            .prefix("Z: ")
                            .speed(0.1),
                    )
                    .changed()
            ...
            ui.horizontal(|ui| {
                ...
                if ui
                    .add(
                        egui::DragValue::new(&mut self.settings.physics_settings.fixed_timestep)
                            .speed(0.001)
                            .range(0.001..=0.1),
                    )
                    .changed()
        ...
        ui.collapsing("Audio Settings", |ui| {
            ui.horizontal(|ui| {
                ...
                if ui
                    .add(egui::Slider::new(
                        &mut self.settings.audio_settings.master_volume,
                        0.0..=1.0,
                    ))
                    .changed()
                {
            ...
            ui.horizontal(|ui| {
                ...
                if ui
                    .add(egui::Slider::new(
                        &mut self.settings.audio_settings.sfx_volume,
                        0.0..=1.0,
                    ))
                    .changed()
                {
            ...
            ui.horizontal(|ui| {
                ...
                if ui
                    .add(egui::Slider::new(
                        &mut self.settings.audio_settings.music_volume,
                        0.0..=1.0,
                    ))
                    .changed()
                {
        ...
        ui.collapsing("Input Settings", |ui| {
            ui.horizontal(|ui| {
                ...
                if ui
                    .add(egui::Slider::new(
                        &mut self.settings.input_settings.mouse_sensitivity,
                        0.1..=5.0,
                    ))
                    .changed()
                {
            ...
            if ui
                .checkbox(
                    &mut self.settings.input_settings.invert_y_axis,
                    "Invert Y Axis",
                )
                .changed()
            {
