        ...
        ui.collapsing("Build Options", |ui| {
            ui.horizontal(|ui| {
                ...
                egui::ComboBox::from_label("")
                    ...
                    .show_ui(ui, |ui| {
                        ui.selectable_value(
                            &mut self.options.target,
                            BuildTarget::Windows,
                            BuildTarget::Windows.name(),
                        );
                        ui.selectable_value(
                            &mut self.options.target,
                            BuildTarget::Linux,
                            BuildTarget::Linux.name(),
                        );
                        ui.selectable_value(
                            &mut self.options.target,
                            BuildTarget::MacOS,
                            BuildTarget::MacOS.name(),
                        );
                        ui.selectable_value(
                            &mut self.options.target,
                            BuildTarget::Web,
                            BuildTarget::Web.name(),
                        );
                        ui.selectable_value(
                            &mut self.options.target,
                            BuildTarget::Android,
                            BuildTarget::Android.name(),
                        );
                        ui.selectable_value(
                            &mut self.options.target,
                            BuildTarget::iOS,
                            BuildTarget::iOS.name(),
                        );
                    });
            });
