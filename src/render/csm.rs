...
impl CascadedShadowMap {
    ...
    pub fn update_cascades(
        ...
        for i in 0..self.config.cascade_count as usize {
            ...
            // 使用cascade_near和cascade_far计算级联视锥体
            // cascade_near用于视锥体角点计算，确保级联正确覆盖深度范围
            let _cascade_depth_range = cascade_far - cascade_near;
            ...
            // 计算光源视图矩阵
            let light_view = Mat4::look_at_rh(center - light_direction * 50.0, center, Vec3::Y);
