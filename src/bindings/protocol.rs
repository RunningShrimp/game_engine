...
pub enum BindingCommand {
    ...
    SetComponent { entity_id: u64, component: ComponentData },
    GetComponent { entity_id: u64, component_type: String },
    RemoveComponent { entity_id: u64, component_type: String },
    
    // Transform
    SetPosition { entity_id: u64, x: f32, y: f32, z: f32 },
    SetRotation { entity_id: u64, x: f32, y: f32, z: f32, w: f32 },
    SetScale { entity_id: u64, x: f32, y: f32, z: f32 },
    
    // Audio
    PlaySound { name: String, path: String, volume: f32, looped: bool },
...
pub enum BindingEvent {
    // Lifecycle
    OnStart { entity_id: u64 },
    OnUpdate { entity_id: u64, delta_time: f32 },
    OnFixedUpdate { entity_id: u64, fixed_delta: f32 },
    OnDestroy { entity_id: u64 },
    
    // Physics
    OnCollisionEnter { entity_a: u64, entity_b: u64 },
    OnCollisionExit { entity_a: u64, entity_b: u64 },
    OnTriggerEnter { entity_a: u64, entity_b: u64 },
    OnTriggerExit { entity_a: u64, entity_b: u64 },
    
    // Input
    OnKeyDown { key: String },
    OnKeyUp { key: String },
    OnMouseDown { button: u8, x: f32, y: f32 },
    OnMouseUp { button: u8, x: f32, y: f32 },
    
    // Resource
    OnResourceLoaded { handle: u64, resource_type: String },
    OnResourceFailed { path: String, error: String },
    
    // Response to queries
    ComponentData { entity_id: u64, component: ComponentData },
    MousePosition { x: f32, y: f32 },
    KeyState { key: String, pressed: bool },
