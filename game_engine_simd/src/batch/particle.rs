...
impl BatchParticle {
    ...
    /// 批量更新粒子
    pub fn update_particles(&self, particles: &mut [Particle], delta_time: f32) -> BatchStats {
    ...
    pub fn apply_vortex_field(
        ...
        for particle in particles.iter_mut() {
            ...
            // 投影到轴上
            let proj_len =
                to_particle[0] * axis[0] + to_particle[1] * axis[1] + to_particle[2] * axis[2];
...
mod tests {
    ...
    fn test_force_field() {
        ...
        let stats = processor.apply_force_field(&mut particles, [10.0, 0.0, 0.0], 100.0, 20.0);
