...
use crate::config::auto_config::AutoConfig;
use crate::soc::power::{PowerManager, ThermalState};
...
use crate::config::auto_config::ShadowQuality;
...
mod tests {
    ...
    use crate::{HardwareCapability, AutoConfig};
