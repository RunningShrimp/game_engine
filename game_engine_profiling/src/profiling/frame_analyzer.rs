...
mod tests {
    ...
    fn test_frame_analyzer() {
        ...
        let _ = analyzer.add_phase(PhaseMetrics::new("physics", Duration::from_micros(3000)));
        let _ = analyzer.add_phase(PhaseMetrics::new("render", Duration::from_micros(12000)));
        analyzer.end_frame().unwrap();

        analyzer.start_frame(1, Duration::from_millis(17));
        let _ = analyzer.add_phase(PhaseMetrics::new("physics", Duration::from_micros(3100)));
        let _ = analyzer.add_phase(PhaseMetrics::new("render", Duration::from_micros(13000)));
        analyzer.end_frame().unwrap();
    ...
    fn test_variation_coefficient() {
        ...
        for i in 0..5 {
            ...
            let _ = analyzer.add_phase(PhaseMetrics::new(
                "render",
