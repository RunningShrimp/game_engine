...
impl AcousticMaterialProperties {
    pub fn new(transmission: f32, absorption: f32, diffusion: f32, freq_dep: f32) -> Self {
        Self {
...
impl MaterialLibrary {
    ...
    pub fn new() -> Self {
        ...
        materials.insert(
            "air".to_string(),
            AcousticMaterialProperties::new(
                1.0, // 完全传输
                0.0, // 无吸收
                0.0, // 无扩散
                1.0, // 频率无关
        ...
        materials.insert(
            "drywall".to_string(),
            AcousticMaterialProperties::new(0.05, 0.05, 0.1, 0.5),
        );

        materials.insert(
            "plaster".to_string(),
            AcousticMaterialProperties::new(0.03, 0.02, 0.08, 0.45),
        );

        materials.insert(
            "tile_ceramic".to_string(),
            AcousticMaterialProperties::new(
                0.02, 0.01, // 极少吸收
                0.05, // 镜面反射
                0.6,  // 高频反射更多
        ...
        materials.insert(
            "wood_floor".to_string(),
            AcousticMaterialProperties::new(0.08, 0.1, 0.15, 0.65),
        );

        materials.insert(
            "parquet".to_string(),
            AcousticMaterialProperties::new(0.06, 0.08, 0.12, 0.6),
        );
        ...
        materials.insert(
            "sand".to_string(),
            AcousticMaterialProperties::new(0.08, 0.2, 0.35, 0.65),
        );
        ...
        materials.insert(
            "mineral_wool".to_string(),
            AcousticMaterialProperties::new(0.01, 0.85, 0.55, 0.82),
        );

        materials.insert(
            "acoustic_panel".to_string(),
            AcousticMaterialProperties::new(0.01, 0.75, 0.5, 0.8),
        );
